...
interface ClientActionsProps {
  ...
  clientEmail: string;
  isActive: boolean;
  onAction?: (action: string, clientId: number) => void;
}
      ...
      <Dropdown.Menu align="end" className="dropdown-menu-lg">
        ...
        <div className="px-3 py-2 border-bottom">
          <div className="d-flex align-items-center">
            ...
            <div>
              <h6 className="mb-0 text-dark">{clientName}</h6>
              <small className="text-muted">Email: {clientEmail}</small>
              <div>
                {isActive ? (
