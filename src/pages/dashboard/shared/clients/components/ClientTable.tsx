...
const StatisticsCell: React.FC<{ client: Client }> = ({ client }) => {
  ...
  return (
    <div style={{
      ...
      {/* Première ligne : Total des projets */}
      ...
      {/* Deuxième ligne : Projets actifs et terminés */}
      <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
        <span style={{
          ...badgeStyle,
...
const EmptyState: React.FC = () => (
  <div style={{ textAlign: 'center', padding: '3rem 0' }}>
    ...
    <p style={{ color: '#6c757d' }}>Il n'y a pas de clients à afficher pour le moment.</p>
  </div>
);
...
const LoadingState: React.FC = () => (
  <div style={{ textAlign: 'center', padding: '3rem 0' }}>
    ...
    <p style={{ marginTop: '1rem' }}>Chargement des clients...</p>
  </div>
);
    ...
    return (
      <Card style={{ height: '100%' }}>
        <Card.Header style={{ backgroundColor: 'white', padding: '1rem' }}>
          <h4 style={{ marginBottom: 0 }}>Liste des clients</h4>
        </Card.Header>
        <Card.Body>
  ...
  return (
    <Card style={{ height: '100%' }}>
      <Card.Header style={{
        ...
        <h4 style={{ marginBottom: 0 }}>Liste des clients</h4>
        <small style={{ color: '#6c757d' }}>
          {pagination.totalElements} client{pagination.totalElements !== 1 ? 's' : ''} au total
        </small>
      </Card.Header>
                    ...
                    <tr key={client.id}>
                      <td style={{ verticalAlign: 'middle' }}>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                          <div style={{
                            ...
                            height: '2.5rem',
                            borderRadius: '50%',
                            backgroundColor: getAvatarColor(`${client.firstName} ${client.lastName}`),
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'center',
                            marginRight: '0.75rem',
                      ...
                      <td style={{ verticalAlign: 'middle' }}>
                        ...
                        {client.companyName && (
                          <>
                            <br />
                            <small style={{ color: '#6c757d' }}>{client.companyName}</small>
                          </>
                        )}
                      </td>
                      <td style={{ verticalAlign: 'middle' }}>
