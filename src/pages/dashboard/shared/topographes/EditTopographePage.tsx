...
import TopographeEditForm from './components/TopographeEditForm';

const EditTopographePage: React.FC = () => {
  const navigate = useNavigate();
  const { id } = useParams<{ id: string }>();
  const topographeId = id ? parseInt(id) : 0;

  const handleSuccess = () => {
    // Rediriger vers la liste des topographes après modification
    ...
    return (
      <Container fluid className="p-6">
        <div className="text-center">
          <h3>ID de topographe invalide</h3>
        ...
        <Col lg={12} md={12} sm={12}>
          <div className="border-bottom pb-4 mb-4 d-md-flex justify-content-between align-items-center">
            <div className="mb-3 mb-md-0">
              ...
              <p className="mb-0">
                Modification des informations du topographe
              </p>
            </div>
            <div>
              <Button 
...
export default EditTopographePage;